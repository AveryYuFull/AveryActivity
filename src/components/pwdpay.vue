<template>
  <div v-if="showCard" class="_content">
    <div class="pop-bg">
      <div class="pay-tool">
        ...
        <div class="pay-tool-content">
          <div class="pay-tool-inputs">
            <div class="item" v-for="(item, index) in items" :key="index">
              <span class="icon_dot" v-if="password[index]"></span>
            </div>
          </div>
          <div class="pay-tool-link">忘记密码？</div>
        </div>
        <div class="pay-tool-keyboard">
          <ul>
            <li @click="keyUpHandle($event)" v-for="(item, index) in keys" :key="index">
              {{item}}
            </li>
